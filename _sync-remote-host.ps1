...
$src = $src -replace "install-help\.js(\?v=[^`"]+)?", "install-help.js?v=v20"
$src = $src -replace "sw\.js(\?v=[^`"]+)?", "sw.js?v=fb7"
$src = $src -replace "digital-remote\.css(\?v=[^`"]+)?", "digital-remote.css?v=dig22"
