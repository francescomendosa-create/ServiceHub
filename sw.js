...
const CACHE_NAME = 'servicehub-shell-realtime-sync-v2-v113';
...
const SHELL_FILES = [
  ...
  './remote/manifest.json?v=dr4',
  './sh-remote-icon-192.png?v=dr4',
  './sh-remote-icon-512.png?v=dr4',
  './splash-remote-mobile.png?v=dr4',
  './splash-remote-pc.png?v=dr4'
];
